...
public class ThreeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String[] TITLE = {"用户管理", "客户资料管理"};
    ...
    private void initView() {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.rvThree);
    ...
    private void initAdapter() {
        ...
        homeAdapter.setOnItemClickListener(new QuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(QuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(ThreeActivity.this, ACTIVITY[position]);
