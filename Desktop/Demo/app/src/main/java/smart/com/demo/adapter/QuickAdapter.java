...
import smart.com.demo.entity.IExpandable;
...
public abstract class QuickAdapter<T, K extends ViewHolder> extends RecyclerView.Adapter<K> {
     ...
     */
    private void bindViewClickListener(final ViewHolder baseViewHolder) {
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(QuickAdapter.this, v, position);
    }
    ...
    public interface OnItemChildClickListener {
        ...
        void onItemChildClick(QuickAdapter adapter, View view, int position);
    }

    public interface OnItemChildLongClickListener {

        boolean onItemChildLongClick(QuickAdapter adapter, View view, int position);
    }

    public interface OnItemLongClickListener {

        boolean onItemLongClick(QuickAdapter adapter, View view, int position);
    }
